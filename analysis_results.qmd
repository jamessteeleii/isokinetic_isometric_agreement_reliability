...
The isometric model showed chain convergence with $\hat{R}$ values all $<1.01$ and posterior predictive checks were good. Model diagnostics can be seen in the supplementary materials here: [https://osf.io/ypt59](https://osf.io/ypt59). 
...
The isokinetic model also showed chain convergence with $\hat{R}$ values all $<1.01$ and posterior predictive checks were good. Model diagnostics can be seen in the supplementary materials here: [https://osf.io/wzh9m](https://osf.io/wzh9m). 
