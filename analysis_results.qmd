...
\left(
  \begin{array}{ccc}
     \sigma_{\mu^\text{Chest Press (con)}_{i}} & 0 & 0 & 0 & 0 & 0 \\ 
     0 & \sigma_{\mu^\text{Leg Press (con)}_{i}} & 0 & 0 & 0 & 0 \\ 
     0 & 0 & \sigma_{\mu^\text{Row (con)}_{i}} & 0 & 0 & 0 \\
     0 & 0 & 0 & \sigma_{\mu^\text{Chest Press (ecc)}_{i}} & 0 & 0  \\ 
     0 & 0 & 0 & 0 & \sigma_{\mu^\text{Leg Press (ecc)}_{i}} & 0 \\ 
     0 & 0 & 0 & 0 & 0 &  \sigma_{\mu^\text{Row (ecc)}_{i}} \\
  \end{array}
\right) 
\text{R}
\left(
